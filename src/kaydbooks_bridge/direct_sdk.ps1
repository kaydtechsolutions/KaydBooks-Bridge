...
public static class PrivateReadOnlyDiscovery {
 ...
 public static void ReportQuery(System.Xml.XmlNode node,string correlation) {
  ...
  bool inventory=kind.InnerText=="InventoryValuationSummary"||kind.InnerText=="InventoryValuationSummaryBySite"||kind.InnerText=="InventoryStockStatusByItem";
