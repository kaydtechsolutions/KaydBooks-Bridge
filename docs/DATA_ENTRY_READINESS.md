...
Current selected-eight basic sample qualification is **8/8 (100%)**; the overall v0.1.0 development-pilot workflow is **15/15 (100%)**. See [supported journal, check and transfer scope](QBWC_JOURNALS_CHECKS_TRANSFERS.md). Multi-location transfers do not qualify site-aware inventory sales/purchases.
